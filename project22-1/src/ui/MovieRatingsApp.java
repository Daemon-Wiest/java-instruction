		...
		while (choice!=6) {
			...
			switch (choice) {
				...
				case 2:		// View top rated movies
					...
					System.out.println("==========================");
					List<Movie> highestRated = mc.filterMovies(m -> m.getRating()>=4.0);
				...
				case 3:		// View most recent movies (movies released within last 10 years)
					...
					System.out.println("================================");
					List<Movie> recentMovies = mc.filterMovies(m -> (2021 - m.getYear() <=10));
...
public class MovieRatingsApp {
	...
	public static void main(String[] args) {
		...
		option = Console.getString("Choose a menu option:  ");
		switch (option) {
		case "1":
		break;
		case "2":
